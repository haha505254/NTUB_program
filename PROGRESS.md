...
## 部分尚未完成
- 櫃檯端（B14–B20）：現場掛號、病歷建立/查詢/修改、報到與門診狀態查詢。
- 醫師/護理師端（C21–C24）：報到名單、叫號、暫停/結束門診操作。
- 管理員前端（D25–D30）：醫師資料與班表維護、科別管理、統計報表、公告發佈。
- 系統自動作業（E31–E34）：提醒通知、開放掛號、生產報表、資料備份。

## 建議下一步
1. 優先補齊病患端剩餘功能（家屬管理、代掛、看診進度）。
2. 實作櫃檯操作流程，連結現有模型與事件紀錄。
3. 擴充醫師儀表板，再處理管理端與自動化作業。
...
| B14 | 櫃檯人員現場掛號 | 病患證件、掛號請求 | 櫃檯人員 | 產生一筆新的掛號紀錄 | 掛號單據、看診號碼 | 病患、櫃檯人員 | ⏳ 未實作 |
| B15 | 櫃檯人員建立新病歷 | 病患初診資料 | 櫃檯人員 | 建立一筆新的病患基本資料 | 新病歷號碼 | 病患、櫃檯人員 | ⏳ 未實作 |
