...
## 建議下一步
1. 建立管理員專用前端以維護醫師、班表與科別資料，並補齊公告/統計功能。
2. 規劃系統自動作業流程與排程機制，完善通知、報表與備份。
...
| C21 | 醫師查詢門診列表 | 查詢請求 | 醫師 | 查詢今日已報到的病患列表 | 病患列表(依報到順序) | 醫師 | ✅ 已完成 |
| C22 | 醫師呼叫下一位病患 | 叫號請求 | 醫師 | 更新看診進度、推播叫號資訊 | 下一位病患資料 | 醫師、診間看板、病患 App | ✅ 已完成 |
| C23 | 醫師暫停/恢復看診 | 狀態變更請求 | 醫師 | 更新門診狀態為『暫停看診』或『恢復看診』 | 狀態變更成功確認 | 診間看板、櫃檯人員 | ✅ 已完成 |
| C24 | 醫師宣告門診結束 | 結束請求 | 醫師 | 更新門診狀態為『看診結束』 | 門診結束確認 | 系統 | ✅ 已完成 |
